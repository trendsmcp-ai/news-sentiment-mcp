...
<!-- mcp-name: ai.trendsmcp/news-sentiment-mcp -->

<img src="https://www.trendsmcp.ai/static/pages/trendsmcp/assets/trend.svg" width="72" alt="News Sentiment MCP logo">

# News Sentiment MCP

Live trend data for AI agents. Google, TikTok, YouTube, Amazon, Reddit, and 30+ other sources. One MCP connection, one API key.

[![PyPI](https://img.shields.io/pypi/v/news-sentiment-mcp)](https://pypi.org/project/news-sentiment-mcp/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![CI](https://github.com/trendsmcp-ai/news-sentiment-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/trendsmcp-ai/news-sentiment-mcp/actions/workflows/ci.yml)
...
[![Glama](https://glama.ai/mcp/servers/trendsmcp-ai/news-sentiment-mcp/badges/score.svg)](https://glama.ai/mcp/servers/trendsmcp-ai/news-sentiment-mcp)

[Get a free API key](https://www.trendsmcp.ai/account) · [Docs](https://www.trendsmcp.ai/docs) · [Pricing](https://www.trendsmcp.ai/pricing) · [Data sources](https://www.trendsmcp.ai/data-sources) · [PyPI](https://pypi.org/project/news-sentiment-mcp/) · [Glama](https://glama.ai/mcp/servers/trendsmcp-ai/news-sentiment-mcp)
...
CI: [`.github/workflows/ci.yml`](.github/workflows/ci.yml). Security: [SECURITY.md](SECURITY.md). Issues: [github.com/trendsmcp-ai/news-sentiment-mcp/issues](https://github.com/trendsmcp-ai/news-sentiment-mcp/issues).
